...
pub struct MintTransferableNftV1Args {
...
#[derive(Accounts)]
#[instruction(args: MintTransferableNftV1Args)]
pub struct MintTransferableNftV1<'info> {
  #[account(mut)]
...
impl<'info> MintTransferableNftV1<'info> {
...
pub fn handler(ctx: Context<MintTransferableNftV1>, args: MintTransferableNftV1Args) -> Result<()> {
