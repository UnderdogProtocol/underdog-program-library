...
pub struct InitializeCompressedProjectV1Args {
...
#[derive(Accounts)]
#[instruction(args: InitializeCompressedProjectV1Args)]
pub struct InitializeCompressedProjectV1<'info> {
  #[account(mut)]
...
impl<'info> InitializeCompressedProjectV1<'info> {
