...
#[derive(Accounts)]
#[instruction(args: MintSftV2Args)]
pub struct MintSftV2<'info> {
  #[account(mut)]
...
pub fn handler(ctx: Context<MintSftV2>, args: MintSftV2Args) -> Result<()> {
