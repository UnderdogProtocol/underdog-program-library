...
#[derive(Accounts)]
#[instruction(args: MintNftV3Args)]
pub struct MintNftV3<'info> {
  #[account(mut)]
...
pub fn handler(ctx: Context<MintNftV3>, args: MintNftV3Args) -> Result<()> {
