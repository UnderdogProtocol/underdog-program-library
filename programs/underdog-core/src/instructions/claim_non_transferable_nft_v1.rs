...
pub struct ClaimNonTransferableNftV1Args {
...
#[derive(Accounts)]
#[instruction(args: ClaimNonTransferableNftV1Args)]
pub struct ClaimNonTransferableNftV1<'info> {
  #[account(mut)]
...
impl<'info> ClaimNonTransferableNftV1<'info> {
