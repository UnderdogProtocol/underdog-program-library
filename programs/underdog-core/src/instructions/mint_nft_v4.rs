...
#[derive(Accounts)]
#[instruction(args: MintNftV4Args)]
pub struct MintNftV4<'info> {
  #[account(mut)]
...
pub fn handler(ctx: Context<MintNftV4>, args: MintNftV4Args) -> Result<()> {
