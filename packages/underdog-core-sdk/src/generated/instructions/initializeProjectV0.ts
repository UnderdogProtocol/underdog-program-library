...
// Accounts.
export type InitializeProjectV0InstructionAccounts = {
  authority?: Signer;
...
// Data.
export type InitializeProjectV0InstructionData = {
...
export type InitializeProjectV0InstructionDataArgs = {
  superAdminAddress: PublicKey;
  memberAddress: PublicKey;
  orgId: string;
...
/** @deprecated Use `getInitializeProjectV0InstructionDataSerializer()` without any argument instead. */
export function getInitializeProjectV0InstructionDataSerializer(
  _context: object
): Serializer<
  InitializeProjectV0InstructionDataArgs,
  InitializeProjectV0InstructionData
>;
export function getInitializeProjectV0InstructionDataSerializer(): Serializer<
  InitializeProjectV0InstructionDataArgs,
  InitializeProjectV0InstructionData
>;
export function getInitializeProjectV0InstructionDataSerializer(
...
> {
  return mapSerializer<
    ...
    InitializeProjectV0InstructionData
  >(
    struct<InitializeProjectV0InstructionData>(
      [
      ...
      { description: 'InitializeProjectV0InstructionData' }
    ),
    (value) => ({
      ...value,
      discriminator: [4, 73, 129, 204, 181, 140, 91, 69],
    })
  ) as Serializer<
    InitializeProjectV0InstructionDataArgs,
    InitializeProjectV0InstructionData
...
// Args.
export type InitializeProjectV0InstructionArgs =
  InitializeProjectV0InstructionDataArgs;

// Instruction.
export function initializeProjectV0(
  context: Pick<Context, 'programs' | 'eddsa' | 'identity'>,
  input: InitializeProjectV0InstructionAccounts &
    InitializeProjectV0InstructionArgs
): TransactionBuilder {
  ...
  // Data.
  const data =
    getInitializeProjectV0InstructionDataSerializer().serialize(resolvedArgs);
