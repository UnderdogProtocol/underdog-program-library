...
// Data.
export type MintCompressedNftInstructionData = {
...
export type MintCompressedNftInstructionDataArgs = {
  superAdminAddress: PublicKey;
  memberAddress: PublicKey;
  orgId: string;
  projectIdStr: string;
...
/** @deprecated Use `getMintCompressedNftInstructionDataSerializer()` without any argument instead. */
export function getMintCompressedNftInstructionDataSerializer(
  _context: object
): Serializer<
  MintCompressedNftInstructionDataArgs,
  MintCompressedNftInstructionData
>;
export function getMintCompressedNftInstructionDataSerializer(): Serializer<
  MintCompressedNftInstructionDataArgs,
  MintCompressedNftInstructionData
>;
export function getMintCompressedNftInstructionDataSerializer(
...
> {
  return mapSerializer<
    ...
    MintCompressedNftInstructionData
  >(
    struct<MintCompressedNftInstructionData>(
      [
      ...
      { description: 'MintCompressedNftInstructionData' }
    ),
    (value) => ({
      ...value,
      discriminator: [230, 118, 204, 195, 62, 182, 119, 26],
    })
  ) as Serializer<
    MintCompressedNftInstructionDataArgs,
    MintCompressedNftInstructionData
...
// Args.
export type MintCompressedNftInstructionArgs = PickPartial<
  MintCompressedNftInstructionDataArgs,
  'projectMintBump'
>;
...
export function mintCompressedNft(
  ...
  input: MintCompressedNftInstructionAccounts & MintCompressedNftInstructionArgs
): TransactionBuilder {
  ...
  // Data.
  const data =
    getMintCompressedNftInstructionDataSerializer().serialize(resolvedArgs);
