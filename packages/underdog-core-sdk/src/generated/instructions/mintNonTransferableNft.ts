...
/** @deprecated Use `getMintNonTransferableNftInstructionDataSerializer()` without any argument instead. */
export function getMintNonTransferableNftInstructionDataSerializer(
  _context: object
): Serializer<
  MintNonTransferableNftInstructionDataArgs,
  MintNonTransferableNftInstructionData
>;
export function getMintNonTransferableNftInstructionDataSerializer(): Serializer<
  MintNonTransferableNftInstructionDataArgs,
  MintNonTransferableNftInstructionData
>;
export function getMintNonTransferableNftInstructionDataSerializer(
...
> {
  return mapSerializer<
    ...
    MintNonTransferableNftInstructionData
  >(
    struct<MintNonTransferableNftInstructionData>(
      [
      ...
      { description: 'MintNonTransferableNftInstructionData' }
    ),
    (value) => ({ ...value, discriminator: [58, 75, 84, 72, 62, 36, 245, 76] })
  ) as Serializer<
    MintNonTransferableNftInstructionDataArgs,
    MintNonTransferableNftInstructionData
  >;
...
// Args.
export type MintNonTransferableNftInstructionArgs = PickPartial<
  MintNonTransferableNftInstructionDataArgs,
  'projectMintBump'
>;

// Instruction.
export function mintNonTransferableNft(
  context: Pick<Context, 'programs' | 'eddsa' | 'identity'>,
  input: MintNonTransferableNftInstructionAccounts &
    MintNonTransferableNftInstructionArgs
): TransactionBuilder {
  ...
  // Data.
  const data =
    getMintNonTransferableNftInstructionDataSerializer().serialize(
      resolvedArgs
    );
